...
- Sección **colapsable** «Previsualización de cada G-code» que muestra a la vez las tres previsualizaciones (Contorno, Cavidad, Guías); se puede mostrar u ocultar para no tapar el resto y se actualiza en vivo mientras está abierta.
