(function () {
  // Descriptor de la plantilla EMG40. Generado siguiendo el mismo
  ...
  window.BujiaTemplates["emg40"] = {
    id: "emg40",
    title: "EMG40",
    category: "Pastillas / Bajo",
    description: "Ajusta las dimensiones, revisa la previsualizacion y descarga los tres archivos de G-code mas el <code>preview.svg</code>. El corte va por fuera de la linea; la holgura anade separacion extra (por ejemplo para copiadora). EMG40, carcasa aprox. 102 x 38 mm. Medidas aproximadas basadas en referencias de fabricantes y luthieria; confirma con tu pastilla real antes de cortar.",
    defaults: defaults,
