(function () {
  // Descriptor de la plantilla Filtertron. Generado siguiendo el mismo
  ...
  window.BujiaTemplates["filtertron"] = {
    id: "filtertron",
    title: "Filtertron",
    category: "Pastillas / Guitarra",
    description: "Ajusta las dimensiones, revisa la previsualizacion y descarga los tres archivos de G-code mas el <code>preview.svg</code>. El corte va por fuera de la linea; la holgura anade separacion extra (por ejemplo para copiadora). Gretsch Filtertron, aprox. 71 x 35 mm. Medidas aproximadas basadas en referencias de fabricantes y luthieria; confirma con tu pastilla real antes de cortar.",
    defaults: defaults,
