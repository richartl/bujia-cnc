(function () {
  // Descriptor de la plantilla Jazz Bass. Generado siguiendo el mismo
  ...
  window.BujiaTemplates["jazz-bass"] = {
    id: "jazz-bass",
    title: "Jazz Bass",
    category: "Pastillas / Bajo",
    description: "Ajusta las dimensiones, revisa la previsualizacion y descarga los tres archivos de G-code mas el <code>preview.svg</code>. El corte va por fuera de la linea; la holgura anade separacion extra (por ejemplo para copiadora). Bajo Jazz Bass (bridge), aprox. 95 x 19 mm; el neck es unos 3mm mas corto. Medidas aproximadas basadas en referencias de fabricantes y luthieria; confirma con tu pastilla real antes de cortar.",
    defaults: defaults,
