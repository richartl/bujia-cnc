...
`index.html` es un dashboard que enlaza a herramientas independientes bajo `pages/`. Están operativas Surfacing (`pages/surfacing.html`), Cantos (`pages/edge.html`), Settings (`pages/settings.html`), Plantillas (`pages/templates.html`, con el catálogo completo de pastillas de guitarra y bajo, más Neck Pocket, Puentes, Jack, Controles y Personalizadas) y Verificación (`pages/verify.html`, para revisar y corregir parámetros de un archivo .nc ya generado sin tocar su trayectoria); Ranuras y Taladros aparecen como «Próximamente». Dentro de Plantillas, Pickguards y las siluetas de cuerpo completo en Cavidades también son «Próximamente» (requieren contornos orgánicos reales, ver `docs/architecture.md`).
